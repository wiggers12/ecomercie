...
def _post_onesignal_payload(
    ...
    # evita problemas de parênteses/f-strings em alguns editores
    return False, 500, {"error": "Exception after retries: %r" % (last_exc,)}
...
def notify_admins(
    ...
    """Envia para devices com tag role=admin."""
    payload: Dict[str, Any] = {
